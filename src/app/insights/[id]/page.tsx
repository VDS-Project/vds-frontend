...
import InsightsDetailHeader from "@/components/Insights/InsightsDetailHeader";
import InsightsDetailContent from "@/components/Insights/InsightsDetailContent";
...
async function getBlogPost(slug: string) {
  // ในการใช้งานจริงจะดึงจาก API หรือ CMS
  const mockPost = {
    id: 1,
    title: "Class aptent taciti sociosqu ad litora torquent",
    image: "/img/blog/wide/blog-11.jpg",
    date: "10 June 2025",
    author: "VDS Business Center Administrator",
    content: `
...
export async function generateMetadata({
  ...
  if (!post) {
    return {
      title: "Post Not Found | VDS Insights",
    };
  }
  ...
  return (
    <div className="p-relative bottom-1">
      <div role="main" className="main">
        ...
        <InsightsDetailContent post={post} />
      </div>
    </div>
  );
}
